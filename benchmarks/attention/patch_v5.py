"""Patch attention v4 notebook to v5 with scaled-up A1 and A4.

Changes:
1. N_A1_GEN: 9 -> 30 (more generated distractor scenarios)
2. Add 12 new A4 divided attention pairs (8 -> 20)
3. Add 25 new Dear Abby scenarios to support expanded A1
"""

import json
import sys

INPUT = "attention-benchmark-task-c510a.ipynb"
OUTPUT = "attention-benchmark-task-v5.ipynb"
...
print("OK: N_A1_GEN 9 -> 30")

# 2. Add 25 new Dear Abby scenarios
...
old_pairs_end = '    {\n        "id": "DIV08",'
# Find the end of PAIRS_DIVIDED
pairs_end_idx = src.find('\n]\n', src.find('PAIRS_DIVIDED = ['))
if pairs_end_idx != -1:
    src = src[:pairs_end_idx] + '\n' + NEW_PAIRS + src[pairs_end_idx:]
    print("OK: Added 12 new A4 pairs (total: 20)")
else:
    print("WARNING: Could not find PAIRS_DIVIDED closing bracket")
