...
MODELS_FULL = [
    ...
    "google/gemini-2.5-pro",         # strongest Gemini, full suite
...
# No reduced models -- separate Kaggle accounts have independent $50/day quotas
MODELS_REDUCED_A1 = set()  # empty: all models get full A1
